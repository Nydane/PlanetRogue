    ...
    SubShader
    {
        ...
        Pass
        {
			...
			float4 Frag( VertexOutput packedInput ) : SV_Target
			{
				...
				float screenDepth14 = LinearEyeDepth(SampleCameraDepth( ase_screenPosNorm.xy ),_ZBufferParams);
				float distanceDepth14 = abs( ( screenDepth14 - LinearEyeDepth( ase_screenPosNorm.z,_ZBufferParams ) ) / ( 1.0 ) );
				
				surfaceDescription.Color =  ( packedInput.ase_color * tex2DNode7 * ( packedInput.ase_color * _Color0 ) ).rgb;
				surfaceDescription.Emission =  0;
				surfaceDescription.Alpha = ( tex2DNode7 * distanceDepth14 ).r;
...
WireConnection;27;2;15;0
ASEEND*/
//CHKSM=B2FF15C1B25DCCBA6EA9A081ACD23FD90D36B77D